...
- Projects
   ...
   - AtlasDocs: free document tools running entirely in the browser; OCR that extracts text from images and scanned PDFs, no upload
      - Site at [atlasdocs.io/en/ocr-pdf-image](https://atlasdocs.io/en/ocr-pdf-image)
- Examples
